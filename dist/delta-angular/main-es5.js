...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesToolsFlightsFlightsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      imports: [_components_components_module__WEBPACK_IMPORTED_MODULE_9__["ComponentsModule"], _pages_pages_module__WEBPACK_IMPORTED_MODULE_10__["PagesModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_6__["BrowserAnimationsModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbActionsModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbSidebarModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbLayoutModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbThemeModule"].forRoot({
        name: "default"
      }), _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbIconModule"], _nebular_eva_icons__WEBPACK_IMPORTED_MODULE_8__["NbEvaIconsModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbSidebarModule"].forRoot(), _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbMenuModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbToastrModule"].forRoot(), _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbMenuModule"].forRoot(), _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbDatepickerModule"].forRoot(), _nebular_theme__WEBPACK_IMPORTED_MODULE_7__["NbThemeModule"].forRoot({
        name: "default"
      })],
        ...
        value: function saveGroup() {
          ...
          if (this.nameForm.valid && this.descriptionForm.valid) {
            ...
            this.groupService.createOne(group).subscribe(function (response) {
              if (_this14.upload.uploaded) {
                var groupId = response.data._id;

                _this14.uploadService.uploadImage(_this14.upload.file, "group", groupId).subscribe();
              }

              _this14.toastrService.show("Exito al guardar grupo", "Grupo Guardado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "people-outline"
      ...
      _createClass(GroupEditComponent, [{
        ...
        value: function handleUpdateMetadata() {
          ...
          if (this.group.valid) {
            this.groupService.updateOne(this.id, this.group.value).subscribe(function (response) {
              if (_this15.upload.uploaded) {
                var groupId = response.data._id;

                _this15.uploadService.uploadImage(_this15.upload.file, "group", groupId).subscribe();
              }

              _this15.toastrService.show("Exito al guardar grupo", "Grupo Actualizado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "people-outline"
              ...
              _this15.router.navigate(["grupos"]);
            });
          }
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            ...
            _this16.studentService.findAllInGroup(_this16.id).subscribe(function (response) {
              _this16.members = response.data;
            });
            ...
            _this16.groupService.findById(_this16.id).subscribe(function (response) {
              _this16.group.patchValue(response.data);
            });
          });
        }
      }]);
      ...
      _createClass(GroupItemComponent, [{
        ...
        value: function deleteHandler(id) {
          ...
          this.groupService.deleteOne(id).subscribe(function (response) {
            _this17.toastrService.show("Exito al eliminar grupo", "Grupo Eliminado", {
              status: "primary",
              hasIcon: true,
              destroyByClick: true,
              icon: "trash-outline"
    ...
    function () {
      function GroupComponent(activatedRoute, groupService, studentService) {
        ...
        this.activatedRoute.params.subscribe(function (params) {
          ...
          _this18.groupService.findById(_this18.id).subscribe(function (response) {
            _this18.group = response.data;
          });
          ...
          _this18.studentService.findAllInGroup(_this18.id).subscribe(function (response) {
            _this18.members = response.data;
          });
        });
      }
  ...
  function srcAppPagesGroupsGroupsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function GroupsComponent(groupService) {
        ...
        this.groups = [];
        setTimeout(function () {
          _this19.groupService.findAll().subscribe(function (response) {
            _this19.stcokGroups = response.data;
            _this19.groups = _this19.stcokGroups;
          });
        }, 300);
      }
      ...
      _createClass(GroupsComponent, [{
        ...
        value: function handleReload() {
          ...
          setTimeout(function () {
            _this20.groupService.findAll().subscribe(function (response) {
              _this20.stcokGroups = response.data;
              _this20.groups = _this20.stcokGroups;
            });

            _this20.tabset.selectTab(_this20.tableTab);
          }, 300);
        }
      }, {
        key: "ngOnInit",
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngAfterViewInit() {
          ...
          this.studentService.findAll().subscribe(function (response) {
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_5__(_this22.genderChart.nativeElement, {
              type: "doughnut",
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_5__(_this22.originChart.nativeElement, {
              type: "doughnut",
              data: _this22.getData({
          ...
          this.groupService.findAll().subscribe(function (response) {
            ...
            new chart_js__WEBPACK_IMPORTED_MODULE_5__(_this22.groupChart.nativeElement, {
              type: "bar",
              data: _this22.getData({
  ...
  function srcAppPagesPagesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _tools_flights_flights_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./tools/flights/flights.component */
    "./src/app/pages/tools/flights/flights.component.ts");
    /* harmony import */


    var _students_students_table_students_table_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./students/students-table/students-table.component */
    "./src/app/pages/students/students-table/students-table.component.ts");
    /* harmony import */


    var _students_students_table_student_item_student_item_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    ...
    var _academics_academics_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    ...
    var _groups_group_group_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
    /*! ./groups/group/group.component */
    "./src/app/pages/groups/group/group.component.ts");
    /* harmony import */


    var _groups_group_edit_group_edit_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./groups/group-edit/group-edit.component */
    "./src/app/pages/groups/group-edit/group-edit.component.ts");
    /* harmony import */


    var _groups_group_table_group_table_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./groups/group-table/group-table.component */
    "./src/app/pages/groups/group-table/group-table.component.ts");
    /* harmony import */


    var _groups_group_table_group_item_group_item_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
    /*! ./groups/group-table/group-item/group-item.component */
    "./src/app/pages/groups/group-table/group-item/group-item.component.ts");
    /* harmony import */


    var _groups_group_create_group_create_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
    /*! ./groups/group-create/group-create.component */
    "./src/app/pages/groups/group-create/group-create.component.ts");
    /* harmony import */


    var _subjects_subject_subject_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
    /*! ./subjects/subject/subject.component */
    "./src/app/pages/subjects/subject/subject.component.ts");
    /* harmony import */


    var _subjects_subject_create_subject_create_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
    /*! ./subjects/subject-create/subject-create.component */
    "./src/app/pages/subjects/subject-create/subject-create.component.ts");
    /* harmony import */


    var _subjects_subject_edit_subject_edit_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
    /*! ./subjects/subject-edit/subject-edit.component */
    "./src/app/pages/subjects/subject-edit/subject-edit.component.ts");
    /* harmony import */


    var _subjects_subject_table_subject_table_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
    /*! ./subjects/subject-table/subject-table.component */
    "./src/app/pages/subjects/subject-table/subject-table.component.ts");
    /* harmony import */


    var _subjects_subject_table_subject_item_subject_item_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
    ...
    var _academics_academic_academic_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
    /*! ./academics/academic/academic.component */
    "./src/app/pages/academics/academic/academic.component.ts");
    /* harmony import */


    var _academics_academic_table_academic_table_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
    /*! ./academics/academic-table/academic-table.component */
    "./src/app/pages/academics/academic-table/academic-table.component.ts");
    /* harmony import */


    var _academics_academic_table_academic_item_academic_item_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
    /*! ./academics/academic-table/academic-item/academic-item.component */
    "./src/app/pages/academics/academic-table/academic-item/academic-item.component.ts");
    /* harmony import */


    var _academics_academic_edit_academic_edit_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
    /*! ./academics/academic-edit/academic-edit.component */
    "./src/app/pages/academics/academic-edit/academic-edit.component.ts");
    /* harmony import */


    var _academics_academic_create_academic_create_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
    /*! ./academics/academic-create/academic-create.component */
    "./src/app/pages/academics/academic-create/academic-create.component.ts");
    /* harmony import */


    var _tools_payments_payment_item_payment_item_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
    /*! ./tools/payments/payment-item/payment-item.component */
    "./src/app/pages/tools/payments/payment-item/payment-item.component.ts");
    /* harmony import */


    var _tools_grades_grade_item_grade_item_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
    /*! ./tools/grades/grade-item/grade-item.component */
    "./src/app/pages/tools/grades/grade-item/grade-item.component.ts");
    /* harmony import */


    var _directives_directives_module__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
    /*! ../directives/directives.module */
    "./src/app/directives/directives.module.ts");
    /* harmony import */


    var _students_student_create_student_create_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
    ...
    PagesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_auth_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"], _auth_auth_component__WEBPACK_IMPORTED_MODULE_4__["AuthComponent"], _auth_register_register_component__WEBPACK_IMPORTED_MODULE_5__["RegisterComponent"], _home_home_component__WEBPACK_IMPORTED_MODULE_8__["HomeComponent"], _groups_groups_component__WEBPACK_IMPORTED_MODULE_9__["GroupsComponent"], _subjects_subjects_component__WEBPACK_IMPORTED_MODULE_10__["SubjectsComponent"], _students_students_component__WEBPACK_IMPORTED_MODULE_11__["StudentsComponent"], _students_student_student_component__WEBPACK_IMPORTED_MODULE_12__["StudentComponent"], _students_student_edit_student_edit_component__WEBPACK_IMPORTED_MODULE_13__["StudentEditComponent"], _tools_notes_notes_component__WEBPACK_IMPORTED_MODULE_14__["NotesComponent"], _tools_payments_payments_component__WEBPACK_IMPORTED_MODULE_15__["PaymentsComponent"], _tools_grades_grades_component__WEBPACK_IMPORTED_MODULE_16__["GradesComponent"], _tools_flights_flights_component__WEBPACK_IMPORTED_MODULE_17__["FlightsComponent"], _students_students_table_students_table_component__WEBPACK_IMPORTED_MODULE_18__["StudentsTableComponent"], _students_students_table_student_item_student_item_component__WEBPACK_IMPORTED_MODULE_19__["StudentItemComponent"], _academics_academics_component__WEBPACK_IMPORTED_MODULE_20__["AcademicsComponent"], _groups_group_group_component__WEBPACK_IMPORTED_MODULE_22__["GroupComponent"], _groups_group_edit_group_edit_component__WEBPACK_IMPORTED_MODULE_23__["GroupEditComponent"], _groups_group_table_group_table_component__WEBPACK_IMPORTED_MODULE_24__["GroupTableComponent"], _groups_group_table_group_item_group_item_component__WEBPACK_IMPORTED_MODULE_25__["GroupItemComponent"], _groups_group_create_group_create_component__WEBPACK_IMPORTED_MODULE_26__["GroupCreateComponent"], _subjects_subject_subject_component__WEBPACK_IMPORTED_MODULE_27__["SubjectComponent"], _subjects_subject_create_subject_create_component__WEBPACK_IMPORTED_MODULE_28__["SubjectCreateComponent"], _subjects_subject_edit_subject_edit_component__WEBPACK_IMPORTED_MODULE_29__["SubjectEditComponent"], _subjects_subject_table_subject_table_component__WEBPACK_IMPORTED_MODULE_30__["SubjectTableComponent"], _subjects_subject_table_subject_item_subject_item_component__WEBPACK_IMPORTED_MODULE_31__["SubjectItemComponent"], _academics_academic_academic_component__WEBPACK_IMPORTED_MODULE_32__["AcademicComponent"], _academics_academic_table_academic_table_component__WEBPACK_IMPORTED_MODULE_33__["AcademicTableComponent"], _academics_academic_table_academic_item_academic_item_component__WEBPACK_IMPORTED_MODULE_34__["AcademicItemComponent"], _academics_academic_edit_academic_edit_component__WEBPACK_IMPORTED_MODULE_35__["AcademicEditComponent"], _academics_academic_create_academic_create_component__WEBPACK_IMPORTED_MODULE_36__["AcademicCreateComponent"], _tools_payments_payment_item_payment_item_component__WEBPACK_IMPORTED_MODULE_37__["PaymentItemComponent"], _tools_grades_grade_item_grade_item_component__WEBPACK_IMPORTED_MODULE_38__["GradeItemComponent"], _students_student_create_student_create_component__WEBPACK_IMPORTED_MODULE_40__["StudentCreateComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbTabsetModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbCardModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbInputModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbSelectModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbButtonModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbListModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbTreeGridModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbDatepickerModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbUserModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbIconModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbActionsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_21__["ReactiveFormsModule"], _nebular_theme__WEBPACK_IMPORTED_MODULE_6__["NbStepperModule"], _directives_directives_module__WEBPACK_IMPORTED_MODULE_39__["DirectivesModule"]]
    })], PagesModule);
    /***/
  },
    ...
    function () {
      function StudentCreateComponent(router, schoolService, authService, studentService, uploadService, toastrService, mexicoService, groupService, academicsService) {
        ...
        mexicoService.getStates().subscribe(function (_ref) {
          ...
          _this23.states = response.estado.sort();
        });
        this.groupService.findAll().subscribe(function (response) {
          _this23.groups = response.data;
        });
        this.academicsService.findAll().subscribe(function (response) {
          _this23.academics = response.data;
        });
        this.schoolService.findAll().subscribe(function (response) {
          _this23.schools = response.data;
        });
      }
      ...
      _createClass(StudentCreateComponent, [{
          ...
          if (this.user.valid) {
            ...
            this.studentService.createOne(this.user.value).subscribe(function (response) {
              if (_this24.upload.uploaded) {
                ...
                _this24.uploadService.uploadImage(_this24.upload.file, "student", groupId).subscribe();
              }

              _this24.toastrService.show("Exito al guardar alumno", "Alumno Guardado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "person-outline"
              ...
              _this24.router.navigate(["alumnos"]);
            });
          }
        }
      }, {
        ...
        value: function ngOnInit() {
          ...
          this.user.controls.address.controls.state.valueChanges.subscribe(function (value) {
            if (value != "") {
              _this25.user.controls.address.controls.municipality.setValue("");

              _this25.mexicoService.getMunicipalities(value).subscribe(function (_ref2) {
                var response = _ref2.response;
                _this25.municipalities = response.municipios.sort();
              });
            }
          });
          this.user.controls.address.controls.municipality.valueChanges.subscribe(function (value) {
            if (value != "") {
              _this25.user.controls.address.controls.colony.setValue("");

              _this25.mexicoService.getColonies(value).subscribe(function (_ref3) {
                var response = _ref3.response;
                _this25.cities = response.colonia.sort();
              });
            }
          });
        }
    ...
    function () {
      function StudentEditComponent(router, schoolService, authService, studentService, uploadService, activatedRoute, toastrService, mexicoService, groupService, academicsService) {
        ...
        mexicoService.getStates().subscribe(function (_ref4) {
          ...
          _this26.states = response.estado.sort();
        });
        this.groupService.findAll().subscribe(function (response) {
          _this26.groups = response.data;
        });
        this.academicsService.findAll().subscribe(function (response) {
          _this26.academics = response.data;
        });
        this.schoolService.findAll().subscribe(function (response) {
          _this26.schools = response.data;
        });
      }
      ...
      _createClass(StudentEditComponent, [{
        ...
        value: function saveStudent() {
          ...
          if (this.user.valid) {
            ...
            this.studentService.updateOne(this.id, this.user.value).subscribe(function (response) {
              if (_this27.upload.uploaded) {
                var groupId = response.data._id;

                _this27.uploadService.uploadImage(_this27.upload.file, "student", groupId).subscribe();
              }

              _this27.toastrService.show("Exito al guardar alumno", "Alumno Guardado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "person-outline"
              ...
              _this27.router.navigate(["alumnos"]);
            });
          }
        }
      }, {
        ...
        value: function handleDelete() {
          ...
          this.studentService.deleteOne(this.id).subscribe(function (response) {
            _this28.router.navigate(["alumnos"]);
          });
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.user.controls.address.controls.state.valueChanges.subscribe(function (value) {
            if (value != "") {
              _this29.user.controls.address.controls.municipality.setValue("");

              _this29.mexicoService.getMunicipalities(value).subscribe(function (_ref5) {
                var response = _ref5.response;
                _this29.municipalities = response.municipios.sort();
              });
            }
          });
          this.user.controls.address.controls.municipality.valueChanges.subscribe(function (value) {
            if (value != "") {
              _this29.user.controls.address.controls.colony.setValue("");

              _this29.mexicoService.getColonies(value).subscribe(function (_ref6) {
                var response = _ref6.response;
                _this29.cities = response.colonia.sort();
              });
            }
          });
          this.activatedRoute.params.subscribe(function (params) {
            ...
            _this29.studentService.findById(_this29.id).subscribe(function (response) {
              var schools = {
                schools: response.data.schools[0]
              };
              var data = Object.assign({}, response.data, schools);

              _this29.user.patchValue(data);
            });
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(StudentComponent, [{
        ...
        value: function handleDelete() {
          ...
          this.studentService.deleteOne(this.id).subscribe(function (response) {
            _this30.router.navigate(["alumnos"]);
          });
        }
      }, {
        key: "ngOnInit",
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            _this31.id = params["id"];

            _this31.studentService.findById(_this31.id).subscribe(function (response) {
              _this31.schoolService.findById(response.data.schools[0]).subscribe(function (subresponse) {
                response.data.schools[0] = subresponse.data.name;
              });

              _this31.groupService.findById(response.data.group).subscribe(function (subresponse) {
                response.data.group = subresponse.data.name;
              });

              _this31.academicsService.findById(response.data.program).subscribe(function (subresponse) {
                response.data.program = subresponse.data.name;
              });

              _this31.student = response.data;
            });
          });
        }
      }]);
  ...
  function srcAppPagesStudentsStudentsTableStudentItemStudentItemComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function StudentItemComponent(router, groupService) {
  ...
  function srcAppPagesStudentsStudentsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function StudentsComponent(studentService) {
        ...
        this.studentService = studentService;
        setTimeout(function () {
          studentService.findAll().subscribe(function (response) {
            _this32.students = response.data;
          });
          studentService.findAll(true).subscribe(function (response) {
            _this32.graduates = response.data;
          });
        }, 300);
      }
  ...
  function srcAppPagesSubjectsSubjectCreateSubjectCreateComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _validators_subject_validators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../validators/subject.validators */
    "./src/app/validators/subject.validators.ts");
    /* harmony import */


    var _services_subjects_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../../../services/subjects.service */
    "./src/app/services/subjects.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function SubjectCreateComponent(formBuilder, router, subjectsService, uploadService, toastrService) {
          ...
          if (this.informationForm.valid && this.descriptionForm.valid && this.contactForm.valid) {
            ...
            this.subjectsService.createOne(subject).subscribe(function (response) {
              if (_this33.upload.uploaded) {
                ...
                _this33.uploadService.uploadImage(_this33.upload.file, "subject", subjectId).subscribe();
              }

              _this33.toastrService.show("Exito al guardar la materia", "Materia Guardada", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
      ...
      _createClass(SubjectEditComponent, [{
        ...
        value: function handleUpdate() {
          ...
          if (this.subject.valid) {
            this.subjectService.updateOne(this.id, this.subject.value).subscribe(function (response) {
              if (_this34.upload.uploaded) {
                var subjectId = response.data._id;

                _this34.uploadService.uploadImage(_this34.upload.file, "subject", subjectId).subscribe();
              }
            });
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            ...
            _this35.subjectService.findById(_this35.id).subscribe(function (response) {
              _this35.subject.patchValue(response.data);
            });
          });
        }
      }]);
        ...
        value: function addSubject(subjectId) {
          ...
          if (!this.isAdded && this.academicId != "") {
            ...
            this.academicsService.addSubject(this.academicId, subjectId).subscribe(function (response) {
              _this36.isAdded = true;

              _this36.reload.emit(true);
            });
          }
        }
      }, {
      ...
      _createClass(SubjectComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.params.subscribe(function (params) {
            ...
            _this38.subjectService.findById(_this38.id).subscribe(function (response) {
              _this38.subject = response.data;
              return _this38.gradesService.findAllInSubject(_this38.id).subscribe(function (response) {
                _this38.grades = response.data;
              });
            });
          });
        }
  ...
  function srcAppPagesSubjectsSubjectsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function SubjectsComponent(subjectsService) {
        ...
        this.subjects = [];
        setTimeout(function () {
          _this39.subjectsService.findAll().subscribe(function (response) {
            _this39.stockSubjects = response.data;
            _this39.subjects = _this39.stockSubjects;
          });
        }, 300);
      }
      ...
      _createClass(SubjectsComponent, [{
        ...
        value: function handleReload() {
          ...
          setTimeout(function () {
            _this40.subjectsService.findAll().subscribe(function (response) {
              _this40.stockSubjects = response.data;
              _this40.subjects = _this40.stockSubjects;
            });

            _this40.tabset.selectTab(_this40.tableTab);
          }, 300);
        }
      }, {
        key: "ngOnInit",
  ...
  /***/
  function srcAppPagesToolsFlightsFlightsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesToolsFlightsFlightsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    FlightsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tools/flights/flights.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./flights.component.scss */
      "./src/app/pages/tools/flights/flights.component.scss")).default]
    })], FlightsComponent);
    /***/
  },
    ...
    function () {
      function GradeItemComponent(subjectsService, gradesService, toastrService) {
        ...
        this.subjectsService.findAll().subscribe(function (response) {
          _this41.subjects = response.data;
        });
      }
      ...
      _createClass(GradeItemComponent, [{
        ...
        value: function handleAddSubject() {
          ...
          if (this.subject.valid && this.studentId != "") {
            ...
            this.gradesService.createOne(grade).subscribe(function (response) {
              _this42.reload.emit(true);

              _this42.toastrService.show("Exito al guardar materia", "Materia Asignada", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "book-outline"
        ...
        value: function handleDelete() {
          ...
          this.gradesService.deleteOne(this.gradeInput._id).subscribe(function () {
            _this43.reload.emit(true);

            _this43.toastrService.show("Exito al eliminar calificacion", "Calificacion Deasignada", {
              status: "primary",
              hasIcon: true,
              destroyByClick: true,
              icon: "book-outline"
        ...
        value: function handleUpdate() {
          ...
          if (this.grade.valid && this.studentId != "") {
            ...
            this.gradesService.updateOne(this.gradeInput._id, grade).subscribe(function (response) {
              _this44.toastrService.show("Exito al guardar calificacion", "Calificacion Asignada", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "book-outline"
    ...
    function () {
      function GradesComponent(gradesService, studentService, activatedRoute, router) {
        ...
        this.activatedRoute.params.subscribe(function (params) {
          ...
          _this45.gradesService.findAllInStudent(_this45.id).subscribe(function (response) {
            _this45.grades = response.data;
          });
        });
      }
      ...
      _createClass(GradesComponent, [{
        ...
        value: function handleReload() {
          ...
          setTimeout(function () {
            _this46.gradesService.findAllInStudent(_this46.id).subscribe(function (response) {
  ...
  function srcAppPagesToolsNotesNotesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function NotesComponent(router, activatedRoute, studentService, toastrService) {
        ...
        this.toastrService = toastrService;
        this.activatedRoute.params.subscribe(function (params) {
          _this47.studentService.findById(params["id"]).subscribe(function (response) {
            _this47.student = response.data;
            console.log(_this47.student);
            var note;
            ...
            _this47.editor = new _editorjs_editorjs__WEBPACK_IMPORTED_MODULE_2___default.a({
              holder: "codex-editor",
              tools: {
                header: {
      ...
      _createClass(NotesComponent, [{
        ...
        value: function saveNote() {
          ...
          this.editor.save().then(function (outputData) {
            _this48.student.note = JSON.stringify(outputData);

            _this48.studentService.updateOne(_this48.student._id, _this48.student).subscribe(function (response) {
              _this48.toastrService.show("Exito al guardar nota", "Nota Guardada", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
              ...
              _this48.router.navigate(["alumnos", _this48.student._id]);
            });
          }).catch(function (error) {
            _this48.toastrService.show("Algo anda mal, no se logro al guardar nota", "Intentar en otro momento", {
              status: "warning",
              hasIcon: true,
              destroyByClick: true,
              icon: "alert-triangle-outline"
        ...
        value: function handleCreate() {
          ...
          if (this.payment.valid && this.studentId != "") {
            ...
            this.paymentsService.createOne(payment).subscribe(function () {
              _this49.payment.reset();

              _this49.reload.emit(true);

              _this49.toastrService.show("Exito al generar pago", "Pago Asignado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "credit-card-outline"
        ...
        value: function handleDelete() {
          ...
          if (this.paymentInput) {
            this.paymentsService.deleteOne(this.paymentInput._id).subscribe(function () {
              ...
              _this50.toastrService.show("Exito al eliminar pago", "Pago Eliminado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "credit-card-outline"
        ...
        value: function handlePay() {
          ...
          if (this.paymentInput && !this.isPayed) {
            ...
            this.paymentsService.updateOne(this.paymentInput._id, this.paymentInput).subscribe(function () {
              _this51.toastrService.show("Exito al completar pago", "Pago Registrado", {
                status: "primary",
                hasIcon: true,
                destroyByClick: true,
                icon: "credit-card-outline"
    ...
    function () {
      function PaymentsComponent(router, activatedRoute, studentService, paymentsService, toastrService) {
        ...
        this.activatedRoute.params.subscribe(function (params) {
          ...
          setTimeout(function () {
            _this52.paymentsService.findAllInStudent(_this52.id).subscribe(function (response) {
              _this52.payments = response.data;
            });
          }, 300);
        });
      }
      ...
      _createClass(PaymentsComponent, [{
        ...
        value: function handleReload() {
          ...
          setTimeout(function () {
            _this53.paymentsService.findAllInStudent(_this53.id).subscribe(function (response) {
              _this53.payments = response.data;
            });
          }, 300);
        }
      }, {
    ...
    function () {
      function AcademicsService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this54.headers.Authorization = "bearer ".concat(status.access_token);
          _this54.schoolId = status.schools[0];
        });
      } ////////////////////////////////////////
      //         FIND FUNCTIONS
      ////////////////////////////////////////
  ...
  function srcAppServicesGradesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function GradesService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this55.headers.Authorization = "bearer ".concat(status.access_token);
          _this55.schoolId = status.schools[0];
        });
      }
  ...
  function srcAppServicesGroupServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function GroupService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this56.headers.Authorization = "bearer ".concat(status.access_token);
          _this56.schoolId = status.schools[0];
        });
      }
  ...
  function srcAppServicesPaymentsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function PaymentsService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this57.headers.Authorization = "bearer ".concat(status.access_token);
          _this57.schoolId = status.schools[0];
        });
      }
      ...
      function SchoolService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          if (!lodash__WEBPACK_IMPORTED_MODULE_5__["isEmpty"](status)) {
            _this58.headers.Authorization = "bearer ".concat(status.access_token);
            _this58.schoolId = status.schools[0];
          }
        });
      }
  ...
  function srcAppServicesStudentServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function StudentService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this59.headers.Authorization = "bearer ".concat(status.access_token);
          _this59.schoolId = status.schools[0];
        });
      }
  ...
  function srcAppServicesSubjectsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function SubjectsService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this60.headers.Authorization = "bearer ".concat(status.access_token);
          _this60.schoolId = status.schools[0];
        });
      }
  ...
  function srcAppServicesUploadServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UploadService(http, authService) {
        ...
        authService.authenticated$.subscribe(function (status) {
          _this61.headers.Authorization = "bearer ".concat(status.access_token);
        });
      }
